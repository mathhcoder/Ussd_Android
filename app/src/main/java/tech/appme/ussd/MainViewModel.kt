...
class MainViewModel :BaseViewModel() {
    ...
    private val providersData = MutableLiveData<List<Provider>>()
    val providers : LiveData<List<Provider>> = providersData
    ...
    private val packagesData = MutableLiveData<List<tech.appme.ussd.data.Package>>()
    val packages: LiveData<List<tech.appme.ussd.data.Package>> = packagesData
